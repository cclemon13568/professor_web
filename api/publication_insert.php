...
$paper_id = (string)$next_id; // 轉為字串以符合 char(15)

// ✅ 插入 paper_info
$sql_info = "INSERT INTO paper_info (paper_ID, paper_topic, paper_authors, paper_year, paper_link) VALUES (?, ?, ?, ?, ?)";
$stmt_info = $conn->prepare($sql_info);
$stmt_info->bind_param("sssss", $paper_id, $paper_topic, $paper_authors, $paper_year, $paper_link);
